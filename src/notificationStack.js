  ...
  return (
    <div className="notification-list">
      {props.notifications.map((notification, index) => {
        ...
        const barStyle = props.barStyle(index, notification.barStyle);
        const activeBarStyle = props.activeBarStyle(
          index,
...
NotificationStack.defaultProps = {
  dismissAfter: 1000,
  activeBarStyle: defaultStyleFactory,
  barStyle: defaultStyleFactory
}
